...
============================================================
A 'docs' folder has been added to your home directory. 
You can use these files to further configure your system:

- ~/docs/environments/ : Setup for App & Engine development.
- ~/docs/learning/     : Guides for Production & Terminal mastery.
============================================================
