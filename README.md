...
└── docs/               # Additional resources (copied to ~/docs)
```
...
The system includes optional guides for post-installation setup and system mastery. These are located in the repository and automatically deployed to `~/docs/` on your new system.
